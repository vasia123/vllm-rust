//! AUTO-GENERATED Phase 2 factory for `Llama4ForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Llama4ForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Llama4", Capabilities::TP);

pub struct Llama4ArchFactory;
pub static FACTORY: Llama4ArchFactory = Llama4ArchFactory;

impl ArchFactory for Llama4ArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(Llama4ForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(Llama4ForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
