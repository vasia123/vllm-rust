//! AUTO-GENERATED Phase 2 factory for `OuroForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["OuroForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Ouro", Capabilities::TP);

pub struct OuroArchFactory;
pub static FACTORY: OuroArchFactory = OuroArchFactory;

impl ArchFactory for OuroArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(OuroForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(OuroForCausalLM::new_with_tp(cfg, vb, pg, tp_ctx)?))
    }
