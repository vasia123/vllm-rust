//! AUTO-GENERATED Phase 2 factory for `BagelForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["BagelForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("Bagel", Capabilities::empty());

pub struct BagelArchFactory;
pub static FACTORY: BagelArchFactory = BagelArchFactory;

impl ArchFactory for BagelArchFactory {
