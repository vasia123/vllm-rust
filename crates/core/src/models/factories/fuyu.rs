//! AUTO-GENERATED Phase 2 factory for `FuyuForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["FuyuForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Fuyu", Capabilities::empty());

pub struct FuyuArchFactory;
pub static FACTORY: FuyuArchFactory = FuyuArchFactory;

impl ArchFactory for FuyuArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(FuyuForCausalLM::new(cfg, vb)?))
    }
