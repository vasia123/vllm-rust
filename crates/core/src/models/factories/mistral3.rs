...
pub const ARCH_NAMES: &[&str] = &["Mistral3ForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("Mistral3", Capabilities::empty());

pub struct Mistral3ArchFactory;
pub static FACTORY: Mistral3ArchFactory = Mistral3ArchFactory;

impl ArchFactory for Mistral3ArchFactory {
