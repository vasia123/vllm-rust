//! AUTO-GENERATED Phase 2 factory for `LongcatFlashForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["LongcatFlashForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("LongcatFlash", Capabilities::TP);

pub struct LongcatFlashArchFactory;
pub static FACTORY: LongcatFlashArchFactory = LongcatFlashArchFactory;

impl ArchFactory for LongcatFlashArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(LongcatFlashForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(LongcatFlashForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
