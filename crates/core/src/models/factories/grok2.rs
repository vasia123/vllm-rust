//! AUTO-GENERATED Phase 2 factory for `Grok1ForCausalLM`.
//!
...
static INFO: ArchInfo = ArchInfo::new("Grok1", Capabilities::TP);

pub struct Grok2ArchFactory;
pub static FACTORY: Grok2ArchFactory = Grok2ArchFactory;

impl ArchFactory for Grok2ArchFactory {
