//! AUTO-GENERATED Phase 2 factory for `Lfm2VLForConditionalGeneration`.
//!
...
static INFO: ArchInfo = ArchInfo::new("Lfm2VL", Capabilities::TP);

pub struct Lfm2VlArchFactory;
pub static FACTORY: Lfm2VlArchFactory = Lfm2VlArchFactory;

impl ArchFactory for Lfm2VlArchFactory {
