//! AUTO-GENERATED Phase 2 factory for `Mamba2ForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Mamba2ForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Mamba2", Capabilities::empty());

pub struct Mamba2ArchFactory;
pub static FACTORY: Mamba2ArchFactory = Mamba2ArchFactory;

impl ArchFactory for Mamba2ArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(Mamba2ForCausalLM::new(cfg, vb)?))
    }
