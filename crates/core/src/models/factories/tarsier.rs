//! AUTO-GENERATED Phase 2 factory for `TarsierForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["TarsierForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("Tarsier", Capabilities::empty());

pub struct TarsierArchFactory;
pub static FACTORY: TarsierArchFactory = TarsierArchFactory;

impl ArchFactory for TarsierArchFactory {
