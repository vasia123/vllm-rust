//! AUTO-GENERATED Phase 2 factory for `Step3VLForConditionalGeneration`.
//!
...
static INFO: ArchInfo = ArchInfo::new("Step3VL", Capabilities::empty());

pub struct Step3VlArchFactory;
pub static FACTORY: Step3VlArchFactory = Step3VlArchFactory;

impl ArchFactory for Step3VlArchFactory {
