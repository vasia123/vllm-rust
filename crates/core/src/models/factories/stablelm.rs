//! AUTO-GENERATED Phase 2 factory for `GPTNeoXForCausalLM`.
//!
...
static INFO: ArchInfo = ArchInfo::new("GPTNeoX", Capabilities::QUANTIZED.union(Capabilities::TP));

pub struct StablelmArchFactory;
pub static FACTORY: StablelmArchFactory = StablelmArchFactory;

impl ArchFactory for StablelmArchFactory {
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedGPTNeoXForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
