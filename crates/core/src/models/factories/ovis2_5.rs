//! AUTO-GENERATED Phase 2 factory for `Ovis2_5ForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Ovis2_5"];

static INFO: ArchInfo = ArchInfo::new("Ovis2_5", Capabilities::empty());

pub struct Ovis25ArchFactory;
pub static FACTORY: Ovis25ArchFactory = Ovis25ArchFactory;

impl ArchFactory for Ovis25ArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(Ovis2_5ForConditionalGeneration::new(cfg, vb)?))
    }
