//! AUTO-GENERATED Phase 2 factory for `ChatGLMForCausalLM`.
//!
...
static INFO: ArchInfo = ArchInfo::new("ChatGLM", Capabilities::QUANTIZED.union(Capabilities::TP));

pub struct ChatGlmModelArchFactory;
pub static FACTORY: ChatGlmModelArchFactory = ChatGlmModelArchFactory;

impl ArchFactory for ChatGlmModelArchFactory {
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedChatGLMForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(ChatGLMForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
