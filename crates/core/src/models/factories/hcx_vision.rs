//! AUTO-GENERATED Phase 2 factory for `HCXVisionForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["HCXVisionForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("HCXVision", Capabilities::empty());

pub struct HcxVisionArchFactory;
pub static FACTORY: HcxVisionArchFactory = HcxVisionArchFactory;

impl ArchFactory for HcxVisionArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(HCXVisionForCausalLM::new(cfg, vb)?))
    }
