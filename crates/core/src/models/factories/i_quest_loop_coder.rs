//! AUTO-GENERATED Phase 2 factory for `IQuestLoopCoderForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["IQuestLoopCoderForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("IQuestLoopCoder", Capabilities::TP);

pub struct IQuestLoopCoderArchFactory;
pub static FACTORY: IQuestLoopCoderArchFactory = IQuestLoopCoderArchFactory;

impl ArchFactory for IQuestLoopCoderArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(IQuestLoopCoderForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(IQuestLoopCoderForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
