//! AUTO-GENERATED Phase 2 factory for `GPTJForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["GPTJForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("GPTJ", Capabilities::QUANTIZED.union(Capabilities::TP));

pub struct GptjArchFactory;
pub static FACTORY: GptjArchFactory = GptjArchFactory;

impl ArchFactory for GptjArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(GPTJForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedGPTJForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(GPTJForCausalLM::new_with_tp(cfg, vb, pg, tp_ctx)?))
    }
