//! AUTO-GENERATED Phase 2 factory for `MptForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["MPTForCausalLM", "MptForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Mpt", Capabilities::QUANTIZED.union(Capabilities::TP));

pub struct MptArchFactory;
pub static FACTORY: MptArchFactory = MptArchFactory;

impl ArchFactory for MptArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(MptForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedMptForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
