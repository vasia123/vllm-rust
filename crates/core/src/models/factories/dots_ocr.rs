//! AUTO-GENERATED Phase 2 factory for `DotsOCRForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["DotsOCRForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("DotsOCR", Capabilities::empty());

pub struct DotsOcrArchFactory;
pub static FACTORY: DotsOcrArchFactory = DotsOcrArchFactory;

impl ArchFactory for DotsOcrArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(DotsOCRForCausalLM::new(cfg, vb)?))
    }
