//! AUTO-GENERATED Phase 2 factory for `GraniteForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["GraniteForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Granite", Capabilities::QUANTIZED.union(Capabilities::TP));

pub struct GraniteArchFactory;
pub static FACTORY: GraniteArchFactory = GraniteArchFactory;

impl ArchFactory for GraniteArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(GraniteForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedGraniteForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(GraniteForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
