//! AUTO-GENERATED Phase 2 factory for `MiniCPMVForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["MiniCPMV", "MiniCPMVForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("MiniCPMV", Capabilities::empty());

pub struct MiniCpmvArchFactory;
pub static FACTORY: MiniCpmvArchFactory = MiniCpmvArchFactory;

impl ArchFactory for MiniCpmvArchFactory {
