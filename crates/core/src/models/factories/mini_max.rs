//! AUTO-GENERATED Phase 2 factory for `MiniMaxText01ForCausalLM`.
//!
...
static INFO: ArchInfo = ArchInfo::new("MiniMaxText01", Capabilities::empty());

pub struct MiniMaxArchFactory;
pub static FACTORY: MiniMaxArchFactory = MiniMaxArchFactory;

impl ArchFactory for MiniMaxArchFactory {
