//! AUTO-GENERATED Phase 2 factory for `HunYuanDenseV1ForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["HunYuanDenseV1ForCausalLM"];
...
pub struct HunYuanDenseV1ArchFactory;
pub static FACTORY: HunYuanDenseV1ArchFactory = HunYuanDenseV1ArchFactory;

impl ArchFactory for HunYuanDenseV1ArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(HunYuanDenseV1ForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedHunYuanDenseForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(HunYuanDenseV1ForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
