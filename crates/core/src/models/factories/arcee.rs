//! AUTO-GENERATED Phase 2 factory for `arcee`.
//!
...
pub const ARCH_NAMES: &[&str] = &["ArceeForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("arcee", Capabilities::TP);

pub struct ArceeArchFactory;
pub static FACTORY: ArceeArchFactory = ArceeArchFactory;

impl ArchFactory for ArceeArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(arcee::new_arcee(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(arcee::new_arcee_with_tp(cfg, vb, pg, tp_ctx)?))
    }
