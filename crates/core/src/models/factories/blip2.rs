//! AUTO-GENERATED Phase 2 factory for `Blip2ForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Blip2ForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("Blip2", Capabilities::empty());

pub struct Blip2ArchFactory;
pub static FACTORY: Blip2ArchFactory = Blip2ArchFactory;

impl ArchFactory for Blip2ArchFactory {
