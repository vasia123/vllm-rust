//! AUTO-GENERATED Phase 2 factory for `OvisForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Ovis", "OvisForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("Ovis", Capabilities::empty());

pub struct OvisArchFactory;
pub static FACTORY: OvisArchFactory = OvisArchFactory;

impl ArchFactory for OvisArchFactory {
