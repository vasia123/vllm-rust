//! AUTO-GENERATED Phase 2 factory for `GlmOcrForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["GlmOcrForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("GlmOcr", Capabilities::empty());

pub struct GlmOcrArchFactory;
pub static FACTORY: GlmOcrArchFactory = GlmOcrArchFactory;

impl ArchFactory for GlmOcrArchFactory {
