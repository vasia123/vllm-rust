//! AUTO-GENERATED Phase 2 factory for `Plamo2ForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Plamo2ForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Plamo2", Capabilities::empty());

pub struct Plamo2ArchFactory;
pub static FACTORY: Plamo2ArchFactory = Plamo2ArchFactory;

impl ArchFactory for Plamo2ArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(Plamo2ForCausalLM::new(cfg, vb)?))
    }
