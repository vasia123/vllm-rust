//! AUTO-GENERATED Phase 2 factory for `HunYuanVLForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["HunYuanVLForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("HunYuanVL", Capabilities::empty());

pub struct HunYuanVlArchFactory;
pub static FACTORY: HunYuanVlArchFactory = HunYuanVlArchFactory;

impl ArchFactory for HunYuanVlArchFactory {
