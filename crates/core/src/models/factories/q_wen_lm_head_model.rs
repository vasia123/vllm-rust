//! AUTO-GENERATED Phase 2 factory for `QWenLMHeadModel`.
//!
...
pub const ARCH_NAMES: &[&str] = &["QWenLMHeadModel"];
...
pub struct QWenLmHeadModelArchFactory;
pub static FACTORY: QWenLmHeadModelArchFactory = QWenLmHeadModelArchFactory;

impl ArchFactory for QWenLmHeadModelArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(QWenLMHeadModel::new(cfg, vb)?))
    }
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedQWenLMHeadModel::new(
            cfg,
            vb,
            weight_loader,
        )?))
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(QWenLMHeadModel::new_with_tp(cfg, vb, pg, tp_ctx)?))
    }
