//! AUTO-GENERATED Phase 2 factory for `AyaVisionForConditionalGeneration`.
//!
...
static INFO: ArchInfo = ArchInfo::new("AyaVision", Capabilities::empty());

pub struct AyaVisionArchFactory;
pub static FACTORY: AyaVisionArchFactory = AyaVisionArchFactory;

impl ArchFactory for AyaVisionArchFactory {
