//! AUTO-GENERATED Phase 2 factory for `ChameleonForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["ChameleonForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("Chameleon", Capabilities::empty());

pub struct ChameleonArchFactory;
pub static FACTORY: ChameleonArchFactory = ChameleonArchFactory;

impl ArchFactory for ChameleonArchFactory {
