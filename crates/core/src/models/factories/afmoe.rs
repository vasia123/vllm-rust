//! AUTO-GENERATED Phase 2 factory for `AfmoeForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["AfmoeForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Afmoe", Capabilities::TP);

pub struct AfmoeArchFactory;
pub static FACTORY: AfmoeArchFactory = AfmoeArchFactory;

impl ArchFactory for AfmoeArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(AfmoeForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(AfmoeForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
