//! AUTO-GENERATED Phase 2 factory for `FalconH1ForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["FalconH1ForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("FalconH1", Capabilities::empty());

pub struct FalconH1ArchFactory;
pub static FACTORY: FalconH1ArchFactory = FalconH1ArchFactory;

impl ArchFactory for FalconH1ArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(FalconH1ForCausalLM::new(cfg, vb)?))
    }
