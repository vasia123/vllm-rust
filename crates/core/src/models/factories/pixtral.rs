//! AUTO-GENERATED Phase 2 factory for `PixtralForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["PixtralForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("Pixtral", Capabilities::empty());

pub struct PixtralArchFactory;
pub static FACTORY: PixtralArchFactory = PixtralArchFactory;

impl ArchFactory for PixtralArchFactory {
