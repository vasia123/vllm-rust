//! AUTO-GENERATED Phase 2 factory for `SiglipEmbeddingModel`.
//!
...
pub const ARCH_NAMES: &[&str] = &["SiglipEmbeddingModel", "SiglipModel"];

static INFO: ArchInfo = ArchInfo::new("SiglipEmbedding", Capabilities::empty());

pub struct SiglipModelArchFactory;
pub static FACTORY: SiglipModelArchFactory = SiglipModelArchFactory;

impl ArchFactory for SiglipModelArchFactory {
