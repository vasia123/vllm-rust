//! AUTO-GENERATED Phase 2 factory for `Eagle25VLForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Eagle2_5_VLForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("Eagle25VL", Capabilities::TP);

pub struct Eagle25VlArchFactory;
pub static FACTORY: Eagle25VlArchFactory = Eagle25VlArchFactory;

impl ArchFactory for Eagle25VlArchFactory {
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(Eagle25VLForConditionalGeneration::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
