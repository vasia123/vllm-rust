//! AUTO-GENERATED Phase 2 factory for `Lfm2ForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Lfm2ForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Lfm2", Capabilities::TP);

pub struct Lfm2ArchFactory;
pub static FACTORY: Lfm2ArchFactory = Lfm2ArchFactory;

impl ArchFactory for Lfm2ArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(Lfm2ForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(Lfm2ForCausalLM::new_with_tp(cfg, vb, pg, tp_ctx)?))
    }
