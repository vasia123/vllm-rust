//! AUTO-GENERATED Phase 2 factory for `Qwen2ForRewardModel`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Qwen2ForRewardModel"];

static INFO: ArchInfo = ArchInfo::new("Qwen2ForReward", Capabilities::TP);

pub struct Qwen2ForRewardModelArchFactory;
pub static FACTORY: Qwen2ForRewardModelArchFactory = Qwen2ForRewardModelArchFactory;

impl ArchFactory for Qwen2ForRewardModelArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(Qwen2ForRewardModel::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(Qwen2ForRewardModel::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
