//! AUTO-GENERATED Phase 2 factory for `NemotronHForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["NemotronHForCausalLM", "NemotronHPuzzleForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("NemotronH", Capabilities::empty());

pub struct NemotronHArchFactory;
pub static FACTORY: NemotronHArchFactory = NemotronHArchFactory;

impl ArchFactory for NemotronHArchFactory {
