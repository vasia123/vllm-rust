//! AUTO-GENERATED Phase 2 factory for `AriaForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["AriaForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("Aria", Capabilities::empty());

pub struct AriaArchFactory;
pub static FACTORY: AriaArchFactory = AriaArchFactory;

impl ArchFactory for AriaArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(AriaForConditionalGeneration::new(cfg, vb)?))
    }
