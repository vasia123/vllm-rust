//! AUTO-GENERATED Phase 2 factory for `PanguEmbeddedForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["PanguEmbeddedForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("PanguEmbedded", Capabilities::TP);

pub struct PanguEmbeddedArchFactory;
pub static FACTORY: PanguEmbeddedArchFactory = PanguEmbeddedArchFactory;

impl ArchFactory for PanguEmbeddedArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(PanguEmbeddedForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(PanguEmbeddedForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
