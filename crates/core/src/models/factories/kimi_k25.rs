//! AUTO-GENERATED Phase 2 factory for `KimiK25ForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["KimiK25ForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("KimiK25", Capabilities::empty());

pub struct KimiK25ArchFactory;
pub static FACTORY: KimiK25ArchFactory = KimiK25ArchFactory;

impl ArchFactory for KimiK25ArchFactory {
