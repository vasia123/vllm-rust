//! AUTO-GENERATED Phase 2 factory for `Llama4VLForConditionalGeneration`.
//!
...
static INFO: ArchInfo = ArchInfo::new("Llama4VL", Capabilities::empty());

pub struct Llama4VlArchFactory;
pub static FACTORY: Llama4VlArchFactory = Llama4VlArchFactory;

impl ArchFactory for Llama4VlArchFactory {
