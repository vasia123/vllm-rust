//! AUTO-GENERATED Phase 2 factory for `Phi3ForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Phi3ForCausalLM"];
...
pub struct Phi3ArchFactory;
pub static FACTORY: Phi3ArchFactory = Phi3ArchFactory;

impl ArchFactory for Phi3ArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(Phi3ForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedPhi3ForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(Phi3ForCausalLM::new_with_tp(cfg, vb, pg, tp_ctx)?))
    }
    ...
    fn build_with_lora(
        ...
        Ok(LoraEnabledModel::Phi3(Phi3WithLora::new(cfg, vb)?))
    }
