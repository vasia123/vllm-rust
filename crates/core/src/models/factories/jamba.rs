//! AUTO-GENERATED Phase 2 factory for `JambaForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["JambaForCausalLM", "JambaForSequenceClassification"];

static INFO: ArchInfo = ArchInfo::new("Jamba", Capabilities::empty());

pub struct JambaArchFactory;
pub static FACTORY: JambaArchFactory = JambaArchFactory;

impl ArchFactory for JambaArchFactory {
