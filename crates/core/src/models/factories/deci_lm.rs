//! AUTO-GENERATED Phase 2 factory for `NemotronNasForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["DeciLMForCausalLM", "NemotronNasForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("NemotronNas", Capabilities::TP);

pub struct DeciLmArchFactory;
pub static FACTORY: DeciLmArchFactory = DeciLmArchFactory;

impl ArchFactory for DeciLmArchFactory {
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(NemotronNasForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
