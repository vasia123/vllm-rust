//! AUTO-GENERATED Phase 2 factory for `InternLM2VEForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["InternLM2VEForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("InternLM2VE", Capabilities::TP);

pub struct InternLm2VeArchFactory;
pub static FACTORY: InternLm2VeArchFactory = InternLm2VeArchFactory;

impl ArchFactory for InternLm2VeArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(InternLM2VEForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(InternLM2VEForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
