//! AUTO-GENERATED Phase 2 factory for `GPTBigCodeForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["GPTBigCodeForCausalLM"];
...
pub struct GptBigCodeArchFactory;
pub static FACTORY: GptBigCodeArchFactory = GptBigCodeArchFactory;

impl ArchFactory for GptBigCodeArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(GPTBigCodeForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedGPTBigCodeForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(GPTBigCodeForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
