...
pub struct XlmRobertaModelArchFactory;
pub static FACTORY: XlmRobertaModelArchFactory = XlmRobertaModelArchFactory;

impl ArchFactory for XlmRobertaModelArchFactory {
