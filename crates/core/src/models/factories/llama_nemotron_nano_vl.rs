//! AUTO-GENERATED Phase 2 factory for `LlamaNemotronVLForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Llama_Nemotron_Nano_VL"];

static INFO: ArchInfo = ArchInfo::new("LlamaNemotronVL", Capabilities::empty());

pub struct LlamaNemotronNanoVlArchFactory;
pub static FACTORY: LlamaNemotronNanoVlArchFactory = LlamaNemotronNanoVlArchFactory;

impl ArchFactory for LlamaNemotronNanoVlArchFactory {
