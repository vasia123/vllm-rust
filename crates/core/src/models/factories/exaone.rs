//! AUTO-GENERATED Phase 2 factory for `ExaoneForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["ExaoneForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Exaone", Capabilities::QUANTIZED.union(Capabilities::TP));

pub struct ExaoneArchFactory;
pub static FACTORY: ExaoneArchFactory = ExaoneArchFactory;

impl ArchFactory for ExaoneArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(ExaoneForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedExaoneForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(ExaoneForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
