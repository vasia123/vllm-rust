//! AUTO-GENERATED Phase 2 factory for `FlexOlmoForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["FlexOlmoForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("FlexOlmo", Capabilities::TP);

pub struct FlexOlmoArchFactory;
pub static FACTORY: FlexOlmoArchFactory = FlexOlmoArchFactory;

impl ArchFactory for FlexOlmoArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(FlexOlmoForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(FlexOlmoForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
