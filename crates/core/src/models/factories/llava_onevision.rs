//! AUTO-GENERATED Phase 2 factory for `LlavaOnevisionForConditionalGeneration`.
//!
...
static INFO: ArchInfo = ArchInfo::new("LlavaOnevision", Capabilities::empty());

pub struct LlavaOnevisionArchFactory;
pub static FACTORY: LlavaOnevisionArchFactory = LlavaOnevisionArchFactory;

impl ArchFactory for LlavaOnevisionArchFactory {
