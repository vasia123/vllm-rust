//! AUTO-GENERATED Phase 2 factory for `QwenVLForConditionalGeneration`.
//!
...
static INFO: ArchInfo = ArchInfo::new("QwenVL", Capabilities::empty());

pub struct QwenVlArchFactory;
pub static FACTORY: QwenVlArchFactory = QwenVlArchFactory;

impl ArchFactory for QwenVlArchFactory {
