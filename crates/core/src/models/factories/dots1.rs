//! AUTO-GENERATED Phase 2 factory for `Dots1ForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Dots1ForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Dots1", Capabilities::empty());

pub struct Dots1ArchFactory;
pub static FACTORY: Dots1ArchFactory = Dots1ArchFactory;

impl ArchFactory for Dots1ArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(Dots1ForCausalLM::new(cfg, vb)?))
    }
