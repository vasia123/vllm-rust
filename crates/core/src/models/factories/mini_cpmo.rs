//! AUTO-GENERATED Phase 2 factory for `MiniCPMOForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["MiniCPMO", "MiniCPMOForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("MiniCPMO", Capabilities::empty());

pub struct MiniCpmoArchFactory;
pub static FACTORY: MiniCpmoArchFactory = MiniCpmoArchFactory;

impl ArchFactory for MiniCpmoArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(MiniCPMOForCausalLM::new(cfg, vb)?))
    }
