//! AUTO-GENERATED Phase 2 factory for `PaliGemmaForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["PaliGemmaForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("PaliGemma", Capabilities::empty());

pub struct PaliGemmaArchFactory;
pub static FACTORY: PaliGemmaArchFactory = PaliGemmaArchFactory;

impl ArchFactory for PaliGemmaArchFactory {
