//! AUTO-GENERATED Phase 2 factory for `Qwen3ForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Qwen3ForCausalLM"];
...
pub struct Qwen3ArchFactory;
pub static FACTORY: Qwen3ArchFactory = Qwen3ArchFactory;

impl ArchFactory for Qwen3ArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(Qwen3ForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedQwen3ForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(Qwen3ForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
    ...
    fn build_with_lora(
        ...
        Ok(LoraEnabledModel::Qwen3(Qwen3WithLora::new(cfg, vb)?))
    }
