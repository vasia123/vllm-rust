//! AUTO-GENERATED Phase 2 factory for `KeyeForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["KeyeForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("Keye", Capabilities::empty());

pub struct KeyeArchFactory;
pub static FACTORY: KeyeArchFactory = KeyeArchFactory;

impl ArchFactory for KeyeArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(KeyeForConditionalGeneration::new(cfg, vb)?))
    }
