//! AUTO-GENERATED Phase 2 factory for `Exaone4ForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Exaone4ForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Exaone4", Capabilities::QUANTIZED);

pub struct Exaone4ArchFactory;
pub static FACTORY: Exaone4ArchFactory = Exaone4ArchFactory;

impl ArchFactory for Exaone4ArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(Exaone4ForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedExaone4ForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
