//! AUTO-GENERATED Phase 2 factory for `GraniteMoeForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["GraniteMoeForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("GraniteMoe", Capabilities::TP);

pub struct GraniteMoeArchFactory;
pub static FACTORY: GraniteMoeArchFactory = GraniteMoeArchFactory;

impl ArchFactory for GraniteMoeArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(GraniteMoeForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(GraniteMoeForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
