//! AUTO-GENERATED Phase 2 factory for `Step1ForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Step1ForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Step1", Capabilities::QUANTIZED.union(Capabilities::TP));

pub struct Step1ArchFactory;
pub static FACTORY: Step1ArchFactory = Step1ArchFactory;

impl ArchFactory for Step1ArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(Step1ForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedStep1ForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(Step1ForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
