//! AUTO-GENERATED Phase 2 factory for `Idefics3ForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Idefics3ForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("Idefics3", Capabilities::empty());

pub struct Idefics3ArchFactory;
pub static FACTORY: Idefics3ArchFactory = Idefics3ArchFactory;

impl ArchFactory for Idefics3ArchFactory {
