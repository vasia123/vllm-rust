//! AUTO-GENERATED Phase 2 factory for `Molmo2ForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Molmo2ForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("Molmo2", Capabilities::TP);

pub struct Molmo2ArchFactory;
pub static FACTORY: Molmo2ArchFactory = Molmo2ArchFactory;

impl ArchFactory for Molmo2ArchFactory {
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(Molmo2ForConditionalGeneration::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
