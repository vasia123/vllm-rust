//! AUTO-GENERATED Phase 2 factory for `MiMoV2FlashForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["MiMoForCausalLM", "MiMoV2FlashForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("MiMoV2Flash", Capabilities::TP);

pub struct MiMoArchFactory;
pub static FACTORY: MiMoArchFactory = MiMoArchFactory;

impl ArchFactory for MiMoArchFactory {
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(MiMoV2FlashForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
