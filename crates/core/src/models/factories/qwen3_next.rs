//! AUTO-GENERATED Phase 2 factory for `Qwen3NextForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Qwen3NextForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Qwen3Next", Capabilities::TP);

pub struct Qwen3NextArchFactory;
pub static FACTORY: Qwen3NextArchFactory = Qwen3NextArchFactory;

impl ArchFactory for Qwen3NextArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(Qwen3NextForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(Qwen3NextForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
