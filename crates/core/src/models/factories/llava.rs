//! AUTO-GENERATED Phase 2 factory for `LLaVAForConditionalGeneration`.
//!
...
static INFO: ArchInfo = ArchInfo::new("LLaVA", Capabilities::empty());

pub struct LlavaArchFactory;
pub static FACTORY: LlavaArchFactory = LlavaArchFactory;

impl ArchFactory for LlavaArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(LLaVAForConditionalGeneration::from_model_config(
            cfg, vb,
        )?))
    }
