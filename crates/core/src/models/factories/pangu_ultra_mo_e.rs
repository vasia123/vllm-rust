//! AUTO-GENERATED Phase 2 factory for `PanguUltraMoEForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["PanguUltraMoEForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("PanguUltraMoE", Capabilities::TP);

pub struct PanguUltraMoEArchFactory;
pub static FACTORY: PanguUltraMoEArchFactory = PanguUltraMoEArchFactory;

impl ArchFactory for PanguUltraMoEArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(PanguUltraMoEForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(PanguUltraMoEForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
