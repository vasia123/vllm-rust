//! AUTO-GENERATED Phase 2 factory for `KananaVForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["KananaVForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("KananaV", Capabilities::empty());

pub struct KananaVArchFactory;
pub static FACTORY: KananaVArchFactory = KananaVArchFactory;

impl ArchFactory for KananaVArchFactory {
