//! AUTO-GENERATED Phase 2 factory for `PanguProMoEV2ForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["PanguProMoEV2ForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("PanguProMoEV2", Capabilities::TP);

pub struct PanguProMoEv2ArchFactory;
pub static FACTORY: PanguProMoEv2ArchFactory = PanguProMoEv2ArchFactory;

impl ArchFactory for PanguProMoEv2ArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(PanguProMoEV2ForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(PanguProMoEV2ForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
