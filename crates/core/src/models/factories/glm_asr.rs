//! AUTO-GENERATED Phase 2 factory for `GlmAsrForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["GlmAsrForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("GlmAsr", Capabilities::empty());

pub struct GlmAsrArchFactory;
pub static FACTORY: GlmAsrArchFactory = GlmAsrArchFactory;

impl ArchFactory for GlmAsrArchFactory {
