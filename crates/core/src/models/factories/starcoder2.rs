//! AUTO-GENERATED Phase 2 factory for `StarCoder2ForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Starcoder2ForCausalLM"];
...
pub struct Starcoder2ArchFactory;
pub static FACTORY: Starcoder2ArchFactory = Starcoder2ArchFactory;

impl ArchFactory for Starcoder2ArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(StarCoder2ForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedStarCoder2ForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(StarCoder2ForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
