//! AUTO-GENERATED Phase 2 factory for `PhiMoeForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["PhiMoEForCausalLM", "PhiMoeForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("PhiMoe", Capabilities::TP);

pub struct PhiMoEArchFactory;
pub static FACTORY: PhiMoEArchFactory = PhiMoEArchFactory;

impl ArchFactory for PhiMoEArchFactory {
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(PhiMoeForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
