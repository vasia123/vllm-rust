//! AUTO-GENERATED Phase 2 factory for `BeeForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["BeeForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("Bee", Capabilities::empty());

pub struct BeeArchFactory;
pub static FACTORY: BeeArchFactory = BeeArchFactory;

impl ArchFactory for BeeArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(BeeForConditionalGeneration::from_model_config(
            cfg, vb,
        )?))
    }
