//! AUTO-GENERATED Phase 2 factory for `BloomForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["BloomForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Bloom", Capabilities::QUANTIZED.union(Capabilities::TP));

pub struct BloomArchFactory;
pub static FACTORY: BloomArchFactory = BloomArchFactory;

impl ArchFactory for BloomArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(BloomForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedBloomForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(BloomForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
