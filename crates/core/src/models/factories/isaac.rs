//! AUTO-GENERATED Phase 2 factory for `IsaacForConditionalGeneration`.
//!
...
pub const ARCH_NAMES: &[&str] = &["IsaacForConditionalGeneration"];

static INFO: ArchInfo = ArchInfo::new("Isaac", Capabilities::empty());

pub struct IsaacArchFactory;
pub static FACTORY: IsaacArchFactory = IsaacArchFactory;

impl ArchFactory for IsaacArchFactory {
