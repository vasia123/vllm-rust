//! AUTO-GENERATED Phase 2 factory for `Olmo2ForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Olmo2ForCausalLM", "Olmo3ForCausalLM"];
...
pub struct Olmo2ArchFactory;
pub static FACTORY: Olmo2ArchFactory = Olmo2ArchFactory;

impl ArchFactory for Olmo2ArchFactory {
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedOlmo2ForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(Olmo2ForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
