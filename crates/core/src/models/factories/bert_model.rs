//! AUTO-GENERATED Phase 2 factory for `BertForSequenceEmbedding`.
//!
...
static INFO: ArchInfo = ArchInfo::new("Bert", Capabilities::empty());

pub struct BertModelArchFactory;
pub static FACTORY: BertModelArchFactory = BertModelArchFactory;

impl ArchFactory for BertModelArchFactory {
