//! AUTO-GENERATED Phase 2 factory for `CohereForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Cohere2ForCausalLM", "CohereForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Cohere", Capabilities::QUANTIZED.union(Capabilities::TP));

pub struct CohereArchFactory;
pub static FACTORY: CohereArchFactory = CohereArchFactory;

impl ArchFactory for CohereArchFactory {
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedCohereForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(CohereForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
