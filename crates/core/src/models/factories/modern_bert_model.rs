//! AUTO-GENERATED Phase 2 factory for `ModernBertForEmbedding`.
//!
...
static INFO: ArchInfo = ArchInfo::new("ModernBertForEmbedding", Capabilities::empty());

pub struct ModernBertModelArchFactory;
pub static FACTORY: ModernBertModelArchFactory = ModernBertModelArchFactory;

impl ArchFactory for ModernBertModelArchFactory {
