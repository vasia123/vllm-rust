//! AUTO-GENERATED Phase 2 factory for `InternS1ForConditionalGeneration`.
//!
...
static INFO: ArchInfo = ArchInfo::new("InternS1", Capabilities::empty());

pub struct InternS1ArchFactory;
pub static FACTORY: InternS1ArchFactory = InternS1ArchFactory;

impl ArchFactory for InternS1ArchFactory {
