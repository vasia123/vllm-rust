//! AUTO-GENERATED Phase 2 factory for `GptOssForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["GptOssForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("GptOss", Capabilities::TP);

pub struct GptOssArchFactory;
pub static FACTORY: GptOssArchFactory = GptOssArchFactory;

impl ArchFactory for GptOssArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(GptOssForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(GptOssForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
