//! AUTO-GENERATED Phase 2 factory for `GlmForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["GlmForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Glm", Capabilities::QUANTIZED.union(Capabilities::TP));

pub struct GlmArchFactory;
pub static FACTORY: GlmArchFactory = GlmArchFactory;

impl ArchFactory for GlmArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(GlmForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_quant(
        ...
        Ok(Box::new(QuantizedGlmForCausalLM::new(
            cfg,
            vb,
            weight_loader,
        )?))
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(GlmForCausalLM::new_with_tp(cfg, vb, pg, tp_ctx)?))
    }
