//! AUTO-GENERATED Phase 2 factory for `Qwen25VLForConditionalGeneration`.
//!
...
static INFO: ArchInfo = ArchInfo::new("Qwen25VL", Capabilities::empty());

pub struct Qwen25VlArchFactory;
pub static FACTORY: Qwen25VlArchFactory = Qwen25VlArchFactory;

impl ArchFactory for Qwen25VlArchFactory {
