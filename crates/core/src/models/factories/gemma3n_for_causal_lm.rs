//! AUTO-GENERATED Phase 2 factory for `Gemma3nForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["Gemma3nForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("Gemma3n", Capabilities::TP);

pub struct Gemma3nForCausalLmArchFactory;
pub static FACTORY: Gemma3nForCausalLmArchFactory = Gemma3nForCausalLmArchFactory;

impl ArchFactory for Gemma3nForCausalLmArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(Gemma3nForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(Gemma3nForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
