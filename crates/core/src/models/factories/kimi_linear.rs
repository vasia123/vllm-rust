//! AUTO-GENERATED Phase 2 factory for `KimiLinearForCausalLM`.
//!
...
pub const ARCH_NAMES: &[&str] = &["KimiLinearForCausalLM"];

static INFO: ArchInfo = ArchInfo::new("KimiLinear", Capabilities::TP);

pub struct KimiLinearArchFactory;
pub static FACTORY: KimiLinearArchFactory = KimiLinearArchFactory;

impl ArchFactory for KimiLinearArchFactory {
    ...
    fn build(
        ...
        Ok(Box::new(KimiLinearForCausalLM::new(cfg, vb)?))
    }
    ...
    fn build_with_tp(
        ...
        Ok(Box::new(KimiLinearForCausalLM::new_with_tp(
            cfg, vb, pg, tp_ctx,
        )?))
    }
