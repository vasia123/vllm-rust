...
// LongCat-Flash = vanilla GQA + RoPE + optional QKV bias (o_proj never
// biased). Replaces ~190 lines of duplicated TP scaffolding with a thin
// shim over AttentionBlock.
